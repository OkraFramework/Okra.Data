...
& "C:\Program Files\cov-analysis-win64-7.5.0\bin\cov-build" --dir artifacts\cov-int powershell ./scripts/BuildRelease.ps1

# Zip the resulting files

Write-Zip .\artifacts\cov-int .\artifacts\Okra.Data-cov-int.zip